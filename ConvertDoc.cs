...
namespace LocalNetProject
{
    public class ConvertDoc
    {
        ...
        public ConvertDoc(ILoggerFactory loggerFactory, IGraphClientService graphClientService, IConfiguration config)
        {
            _logger = loggerFactory.CreateLogger<ConvertDoc>();
